...
class Projects extends Component {
  ...
  render() {
    const { one, two, three, four, five, seven, nine } = this.state;
    return (
      <Element name="Projects">
        ...
        {/* ------------------------------- nine -------------------------------*/}
        <Modal isOpen={nine} toggle={this._toggleHandler("nine")}>
          <ModalBody>
            <a
              href="https://ladnetwork.netlify.com/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FullSize src={img9} style={fullSize} alt="movieDB19" />
            </a>
          </ModalBody>
          <ModalHeader style={{ paddingTop: "0" }}>
            <ModalTextWrapper>
              <ModalTitle>Lad Network</ModalTitle>
              <ModalSubTitle />
              <ModalDescription>
                <ul>
                  <li>Ad Network Website </li>
                  <li>
                  ...
                  <li>Node.js , Express , SQLite3 , PostgreSQL</li>
                </ul>
              </ModalDescription>
            </ModalTextWrapper>
          </ModalHeader>
          <ModalFooter toggle={this._toggleHandler("nine")}>
            <Astyle href="https://ladnetwork.netlify.com/" target="_blank">
              <i className="fas fa-globe fa-2x" />
            </Astyle>{" "}
            <Astyle href="https://github.com/labs11-ad-network" target="_blank">
              <i className="fab fa-github fa-2x" />
            </Astyle>
          </ModalFooter>
        </Modal>
